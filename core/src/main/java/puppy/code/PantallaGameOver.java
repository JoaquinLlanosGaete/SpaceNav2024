...
public class PantallaGameOver implements Screen {
	...
	public void render(float delta) {
        ...
        String textoDescripcion = "Presiona cualquier tecla para volver a jugar o usa\n                  ESCAPE para volver al menú.";
        ...
        descripcion.setColor(Color.MAROON);
        ...
        if ((Gdx.input.isTouched() || Gdx.input.isKeyJustPressed(Input.Keys.ANY_KEY)) && !loseSound.isPlaying() && !Gdx.input.isKeyJustPressed(Input.Keys.ESCAPE)) {
